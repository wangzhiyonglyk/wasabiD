                    ...
                    if (this.props.selectAble) {
                        ...
                        if (this.props.singleSelect == true) {
                            ...
                            headers.push( <
                                ...
                                <
                                div className = "wasabi-table-cell"
                                name = "check-column" > < CheckBox { ...props
                                } > < /CheckBox></div >
                                <
                                /th>
                            );
                                ...
                                if (!header || header.hide == true) {
                                    ...
                                    if (this.state.headerMenu.length > 0 && this.state.headerMenu.indexOf(header.label) > -1) { //父组件更新状态值，发现某一行处理被隐藏中，则不显示
                                        ...
                                        if (this.state.menu && index == 0) { //在第一列显示
                                            menuControl = < LinkButton key = "menu"
                                            style = {
                                                {
                                                    color: "#666666",
                                                    fontSize: 12,
                                        ...
                                        if (this.state.editIndex != null && index == 0) { //0是有效值
                                            savecontrol = < LinkButton key = "save"
                                            style = {
                                                {
                                                    color: "#666666",
                                                    fontSize: 12,
                                            ...
                                            tip = "保存"
                                            onClick = {
                                                this.remoteUpdateRow.bind(this, null)
                                            }
                                            />
                                        }
                                        ...
                                        headers.push( <
                                            ...
                                            onMouseMove = {
                                                this.headerMouseMoveHandler
                                            }
                                            onContextMenu = {
                                                this.headerContextMenuHandler
                                            }
                                            onMouseDown = {
                                            ...
                                            style = {
                                                ...
                                                header.label
                                            } < /span>{menuControl}{savecontrol}</div >
                                            <
                                            /th>)
                            ...
                            this.state.data.map((rowData, rowIndex) => {
                                        ...
                                        if (this.props.selectAble) {
                                            ...
                                            if (this.props.singleSelect == true) {
                                                tds.push( <
                                                    td key = {
                                                        "bodycheckbox" + rowIndex.toString()
                                                    }
                                                    className = "check-column"
                                                    style = {
                                                        {
                                                    ...
                                                    <
                                                    div className = "wasabi-table-cell" > < Radio { ...props
                                                    } > < /Radio></div > < /td>
                                                );
                                                ...
                                                tds.push( <
                                                    ...
                                                    <
                                                    div className = "wasabi-table-cell" > < CheckBox { ...props
                                                    } > < /CheckBox></div > < /td>
                                                );
                                            }
                                        }
                                        ...
                                        this.state.headers.map((header, columnIndex) => {
                                                ...
                                                if (this.state.editIndex != null && this.state.editIndex == rowIndex && header.editor) {
                                                    ...
                                                    if (columnIndex == 0 && this.props.detailAble) {
                                                        ...
                                                        tds.push( < td onClick = {
                                                                this.detailHandler.bind(this, rowIndex, rowData)
                                                            }
                                                            key = {
                                                                "col" + rowIndex.toString() + "-" + columnIndex.toString()
                                                            } >
                                                            <
                                                            div className = "wasabi-table-cell"
                                                            style = {
                                                            ...
                                                            div style = {
                                                                ...
                                                                content
                                                            } < /div><LinkButton iconCls={iconCls} color="#666666" tip="查看详情"></LinkButton >
                                                            <
                                                            /div> <
                                                            /td>);
                                                        }
                                                            ...
                                                            tds.push( < td onClick = {
                                                                    this.onClick.bind(this, rowIndex, rowData)
                                                                }
                                                                onDoubleClick = {
                                                                    this.onDoubleClick.bind(this, rowIndex, rowData)
                                                                }
                                                                key = {
                                                                    "col" + rowIndex.toString() + "-" + columnIndex.toString()
                                                                } >
                                            ...
                                            trobj.push( < tr className = {
                                                ...
                                                onMouseDown = {
                                                    this.onMouseDown.bind(this, rowIndex)
                                                } > {
                                                    tds
                                                } < /tr>);
                                    ...
                                    renderTotal: function () { //渲染总记录数，当前记录的下标
                                        if (this.state.headers && this.state.headers.length > 0) {
                                            ...
                                            var totalControl = < span className = "pagination-info" > 第 {
                                                this.state.pageIndex
                                            }
                                            /{pageTotal}页,共{total}行记录</span > ;
                                            if (this.props.pagination == false) {
                                                totalControl = < span className = "pagination-info" > 共 {
                                                    total
                                                }
                                                行记录 < /span>;
                                            }
                                            control = < div key = "pagination-detail"
                                            className = "pagination-detail" > {
                                                ...
                                                } > 每页 < select className = "page-select"
                                            value = {
                                                this.state.pageSize
                                            }
                                            onChange = {
                                    ...
                                    renderPagination: function (type) { //显示分页控件
                                        ...
                                        if (this.props.pagination) {
                                            ...
                                            if (pageTotal > 3) { //大于3页，
                                                ...
                                                className = "page-pre" > < a href = "javascript:void(0)"
                                                onClick = {
                                                        this.prePaginationHandler
                                                    } > {
                                                        "<"
                                                    } < /a></li >
                                                    ...
                                                    <
                                                    li key = "linext"
                                                className = "page-next" > < a href = "javascript:void(0)"
                                                onClick = {
                                                        this.nextPaginationHandler
                                                    } > {
                                                        ">"
                                                    } < /a></li >
                                                    <
                                                ...
                                                for (let i = 0; i < pageTotal; i++) {
                                                    ...
                                                    className = {
                                                            "page-number " + ((this.state.pageIndex * 1) == (i + 1) ? "active" : "")
                                                        } >
                                                        <
                                                        a href = "javascript:void(0)"
                                                    onClick = {
                                                        this.paginationHandler.bind(this, (i + 1))
                                                    } > {
                                                        (i + 1)
                                                    } < /a></li > ;
                                                            ...
                                                            if (footerchild[0].value != null && footerchild[0].value != undefined) { //如果有值
                                                                ...
                                                                tds.push( < td key = {
                                                                                ...
                                                                                tds.push( < td key = {
                                                                                    ...
                                                                                    case "avg":
                                                                                        ...
                                                                                        if (obj[header.name] != null) {
                                                                                            ...
                                                                                            tds.push( < td key = {
                                                                                                    header.name + headerindex
                                                                                                } > < /td>);
                                                                                            }

                                                                                        });

                                                                                return <tr key = "footertr"
                                                                                style = {
                                                                                    {
                                                                                        height: 36
                                                                                    }
                                                                    ...
                                                                    render: function () {
                                                                        ...
                                                                        if (this.state.headerMenu.length > 0) {
                                                                            this.state.headerMenu.map((item, index) => {
                                                                                headerMenuCotrol.push( <
                                                                                    ...
                                                                                    onMouseDown = {
                                                                                        this.menuHeaderShowHandler.bind(this, index, item)
                                                                                    } > {
                                                                                        "显示[" + item + "]"
                                                                                    } < /a></li > )
                                                                            })
                                                                        ...
                                                                        return ( <
                                                                            div className = "wasabi-table"
                                                                            ref = "grid"
                                                                            onPaste = {
                                                                                this.onPaste
                                                                            }
                                                                            onMouseDown = {
                                                                                this.gridMouseDownHandler
                                                                            }
                                                                            onContextMenu = {
                                                                                this.gridContextMenuHandler
                                                                            }
                                                                            style = {
                                                                                {
                                                                            ...
                                                                            ref = "fixedTable"
                                                                            onMouseMove = {
                                                                                this.fixedTableMouseMoveHandler
                                                                            }
                                                                            onMouseUp = {
                                                                                this.fixedTableMouseUpHandler
                                                                            } >
                                                                            <
                                                                            thead >
                                                                            <
                                                                            ...
                                                                            <
                                                                            /div> <
                                                                            div className = "wasabi-table-loading"
                                                                            style = {
                                                                                {
                                                                                    display: this.state.loading == true ? "block" : "none"
                                                                                }
                                                                            } > < /div> <
                                                                            div className = "wasabi-load-icon"
                                                                            style = {
                                                                                {
                                                                                    display: this.state.loading == true ? "block" : "none"
                                                                                }
                                                                            ...
                                                                            div className = "wasabi-header-menu-container"
                                                                            ref = "headermenu" >
                                                                            <
                                                                            ul className = "wasabi-header-menu" >
                                                                            <
                                                                            li key = "first" > < a href = "javascript:void(0);"
                                                                            className = "header-menu-item"
                                                                            onMouseDown = {
                                                                                this.menuHideHandler
                                                                            } > 隐藏此列 < /a></li > {
                                                                                headerMenuCotrol
                                                                            } <
                                                                            /ul> <
                                                                            /div> <
                                                                            div className = "wasabi-table-panel"
                                                                            style = {
                                                                                {
                                                                            ...
                                                                            <
                                                                            div className = "wasabi-table-panel-body" > {
